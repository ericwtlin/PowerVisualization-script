...
def main():
    ...
    '''
    result = convert_coordinates("116.29966, 39.96912;116.29966, 39.96912" );
    print(result)
    result[0]['x'] = round(result[0]['x'], 5);
    result[0]['y'] = round(result[0]['y'], 5);
    result[1]['x'] = round(result[1]['x'], 5);
    result[1]['y'] = round(result[1]['y'], 5);
    print(result)
    '''
